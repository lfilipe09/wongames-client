...
//Aqui a gnt tá estendendo o cypress
//Chainable = cadeia, permite juntar compando, usa quando faz um get depois um click em algo por ex
declare namespace Cypress {
  interface Chainable {
     ...
     * @example cy.getByDataCy('seletor')
     */
