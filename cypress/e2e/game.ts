...
describe('Game Page', () => {
  ...
  it('should render game page sections', () => {
    ...
    //o content tem pelo menos o description e o corpo todo de texto
    //O children precisaestar encadeado com algo
  ...
  it('should add/remove game in cart', () => {
    ...
    //faz assim porque existem 2 carrinhos e por isso tá fazendo assim pra pegar só um
    //no mobile tem outro carrinho com mesmo ícone e label
