...
describe('validation', () => {
  ...
  describe('signUpValidate', () => {
    it('should validate empty fields', () => {
      ...
      expect(signUpValidate(values)).toMatchObject({
        email: expect.any(String), //espra qualquer string em resposta
        username: expect.any(String), //espra qualquer string em resposta
        password: expect.any(String), //espra qualquer string em resposta
        confirm_password: expect.any(String) //espra qualquer string em resposta
      })
    })
  ...
  describe('resetValidate()', () => {
    ...
    it('should validate confirm password when different', () => {
      const values = { password: '123', confirm_password: '213' }
